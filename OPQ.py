...
# index = index_factory(128, "OPQ16,PQ16+8")
# index.train(PQtrain)

# Save codebook
index_name = "index_OPQ_Gaussian_hubness16_average_{}_{}.index".format(bits, nlist)
...
for big_cluster in range(1):
    ...
    for times in range(10000):
        ...
        # index_ivfPQ = index_factory(128, "OPQ16,PQ16+8")
        # index_ivfPQ = faiss.read_index(index_name)
        ...
        totoal_128mem = opq.apply_py(totoal_128mem)

        # add vectors to the index
        index_ivfPQ.add_with_ids(totoal_128mem,totoal_mem_Id )          
        ...
        single_query = opq.apply_py(single_query)

        # search
        D, I = index_ivfPQ.search(single_query, k)     
    ...
    save_path = './output/recallPQ/OPQ_Gaussian_hubness16_average_{}_{}_recall_{}_10.txt'.format(bits, nlist, str(big_cluster+1))
